...
command_template = (
    "python Graph_Color_dist_emulate.py --data IGB --path /mnt/nvme15/IGB260M --batch_size 1024 --dataset_size medium --fan_out '10,5,5' "
