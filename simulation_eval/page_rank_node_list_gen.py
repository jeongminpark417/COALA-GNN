...
from dataloader import load_ogb
...
def compute_pagerank(orig_g, DAMP, K, N):
    g = dgl.reverse(orig_g, copy_ndata=True)
...
if __name__ == '__main__':
   ...
   # device = f'cuda:' + str(args.device) if torch.cuda.is_available() else 'cpu'
    ...
    torch_tensor = torch.tensor(norm_pv, dtype=torch.uint8)
    torch.save(torch_tensor, "./static_info.pt")
